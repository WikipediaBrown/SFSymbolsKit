...
file.write("//\n")
file.write("//  Generated by StringExtensionTests.py on ")
...
with open('SFSymbols.txt') as topo_file:
    for line in topo_file:
        ...
        file.write("        let image = NSImage(named: string)\n")
        file.write("        let comparitor = NSImage()")
        file.write("        #elseif canImport(UIKit)\n")
        file.write("        let image = UIImage(systemName: string)\n")
        file.write("        let comparitor = UIImage()")
        file.write("        #endif\n")
        file.write("        // Assert\n")
        file.write("        XCTAssertNotEqual(image, comparitor)\n")
        file.write("    }\n\n")
file.write("}\n")
file.close()
