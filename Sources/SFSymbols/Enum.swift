...
//  SFSymbols
//
//  Generated by Enum.py on 07/11/23.
//

/// `SFSymbol` is an enum with a case for every SFSymbol. Cases are each the string name for the symbol. Cases are generated.
public enum SFSymbol: String, CaseIterable {
    ...
    /// `string` is a computed propterty that maps the case to it's corresponding ``String``.
